...
from game.utils.constants import ENEMY_1, SHIP_WIDTH, SCREEN_WIDTH, SCREEN_HEIGHT, SHIP_HEIGHT
...
class Enemy(Sprite):
    ...
    def change_movement_x(self):
        ...
        if (self.step >= self.move_x_for and self.movement_x == 'left') or (self.rect.x <= 0):
